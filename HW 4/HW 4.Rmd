...
Instrumental Variable: Judge's political affiliation
...
The F-statistic from the model is 164.3. The F-statistic is significant (p < .001), meaning it is above the conventional threshold.
